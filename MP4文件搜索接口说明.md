...
```bash
# 搜索指定路径下的MP4文件
curl "http://127.0.0.1:8082/api/files/mp4?path=/Users/yongjun.xiao/Downloads/telegram_downloads"

# 递归搜索子目录
curl "http://127.0.0.1:8082/api/files/mp4?path=/Users/yongjun.xiao/Downloads/telegram_downloads&recursive=true"

# 按文件大小排序，获取最大的3个文件
curl "http://127.0.0.1:8082/api/files/mp4?path=/Users/yongjun.xiao/Downloads/telegram_downloads&recursive=true&sort_by=size&sort_order=desc&limit=3"

# 分页获取文件
curl "http://127.0.0.1:8082/api/files/mp4?path=/Users/yongjun.xiao/Downloads/telegram_downloads&recursive=true&limit=5&offset=10"
```
...
```bash
# 搜索特定子目录
curl "http://127.0.0.1:8082/api/files/mp4/电影探长%20电影解说新片推荐%20高分热门国产日韩欧美电影"

# 递归搜索子目录
curl "http://127.0.0.1:8082/api/files/mp4/电影探长%20电影解说新片推荐%20高分热门国产日韩欧美电影?recursive=true&limit=10"
```
...
```bash
curl "http://127.0.0.1:8082/api/files/mp4?path=/path/to/videos&recursive=true"
```

### 2. 获取最大的MP4文件

```bash
curl "http://127.0.0.1:8082/api/files/mp4?path=/path/to/videos&recursive=true&sort_by=size&sort_order=desc&limit=1"
```

### 3. 获取最新的MP4文件

```bash
curl "http://127.0.0.1:8082/api/files/mp4?path=/path/to/videos&recursive=true&sort_by=date&sort_order=desc&limit=1"
```
...
```bash
# 第1页
curl "http://127.0.0.1:8082/api/files/mp4?path=/path/to/videos&recursive=true&limit=10&offset=0"

# 第2页
curl "http://127.0.0.1:8082/api/files/mp4?path=/path/to/videos&recursive=true&limit=10&offset=10"
```

### 5. 搜索特定子目录

```bash
curl "http://127.0.0.1:8082/api/files/mp4/子目录名称?recursive=true"
```
...
# 测试特定查询
curl "http://127.0.0.1:8082/api/files/mp4?path=/Users/yongjun.xiao/Downloads/telegram_downloads&recursive=true&limit=5"
```
